...
modules=$(ROOT)/bootloaders $(ROOT)/module-protocol $(ROOT)/data-protocol $(ROOT)/app-protocol $(ROOT)/fkfs $(ROOT)/phylum $(ROOT)/arduino-logging $(ROOT)/lwstreams $(ROOT)/lwcron $(ROOT)/enhanced-io $(ROOT)/simple-lora-comms $(ROOT)/firmware-common $(ROOT)/example-module $(ROOT)/atlas $(ROOT)/weather $(ROOT)/naturalist $(ROOT)/sonar $(ROOT)/core $(ROOT)/fona $(ROOT)/cloud $(ROOT)/testing $(ROOT)/app
