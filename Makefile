...
modules=$(ROOT)/firmware-common $(ROOT)/example-module $(ROOT)/fkfs $(ROOT)/atlas $(ROOT)/weather $(ROOT)/module-protocol $(ROOT)/app-protocol $(ROOT)/sonar $(ROOT)/core $(ROOT)/cloud $(ROOT)/app
